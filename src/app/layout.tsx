...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "poshtichka.eu",
    "пощичка за сватби",
    "poshtichka za svatbi",

    // Core Vending Machine Terms
    "вендинг машина",
    "vending mashina",
    "вендинг машина за сватби",
    "vending mashina za svatbi",
    "вендинг машина под наем",
    "vending mashina pod naem",
    "интерактивна вендинг машина",
    "interaktivna vending mashina",
    "сватбена вендинг машина",
    "svatbena vending mashina",

    // Guest Gifts & Wedding Favors
    "подаръци за гости",
    "podaraci za gosti",
    "подаръчета за гости",
    ...
    // Wedding Entertainment & Events
    "сватбена пощичка",
    "svatbena poshtichka",
    "забавление за сватба",
    "zabavlenie za svatba",
    "атракциони за сватба",
    "atraktsioni za svatba",
    "сватбен реквизит",
    "svatben rekvizit",
    "идеи за сватба",
    "idei za svatba",
    ...
    // Location specific
    "вендинг машина бургас",
    "vending mashina burgas",
    "пощичка бургас",
    "poshtichka burgas",
  ],
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.poshtichka.eu/media/poshtichka-vending-mashina-svatbi.webp",
        width: 1200,
        height: 630,
        alt: "Пощичка - Интерактивна ретро вендинг машина за сватби и събития",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Интерактивна вендинг машина под наем за сватби и специални събития, която превръща традиционните подаръци за гости в незабравимо забавление. Услугата включва цялостна персонализация и изработка на уникални хартиени материали по идея на клиента - авторски марки, картички, стикери, временни татуировки, карти с предизвикателства, благодарствени картички. По време на тържеството гостите сами изтеглят своя подарък от машината, което създава вълнуваща атмосфера, момент на изненада и различен спомен, който всеки отнася у дома. Концепцията е модерен и нестандартен заместител на класическите сватбени подаръчета, адаптиран изцяло спрямо темата и визията на събитието.",
    images: ["https://www.poshtichka.eu/media/poshtichka-vending-mashina-svatbi.webp"],
  },
};
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "@type": "LocalBusiness",
    "name": "Пощичка",
    "image": "https://www.poshtichka.eu/media/poshtichka-vending-mashina-svatbi.webp",
    "description":
      "Интерактивна вендинг машина под наем за сватби и специални събития, която превръща традиционните подаръци за гости в незабравимо забавление. Услугата включва цялостна персонализация и изработка на уникални хартиени материали по идея на клиента - авторски марки, картички, стикери, временни татуировки, карти с предизвикателства, благодарствени картички. По време на тържеството гостите сами изтеглят своя подарък от машината, което създава вълнуваща атмосфера, момент на изненада и различен спомен, който всеки отнася у дома. Концепцията е модерен и нестандартен заместител на класическите сватбени подаръчета, адаптиран изцяло спрямо темата и визията на събитието.",
    "serviceType": [
