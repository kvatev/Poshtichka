    ...
    <div className="space-y-16 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <Card className="p-6 space-y-3">
              ...
              <a
                ...
                className="text-sm font-sans text-brand-accent hover:underline font-semibold"
              >
                +359 888 000 000
              </a>
            </Card>
          ...
          {/* Google Maps Embed */}
          <div className="rounded-3xl overflow-hidden shadow-glass border border-brand-primary/30 h-72 relative">
            <iframe
              title="Карта Бургас"
        ...
        <Card className="p-8 sm:p-10 space-y-6">
          {submitted ? (
            <div className="text-center py-12 space-y-4">
              <div className="w-16 h-16 rounded-full bg-brand-secondary text-brand-accent mx-auto flex items-center justify-center">
