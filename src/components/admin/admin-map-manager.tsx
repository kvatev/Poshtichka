      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-6 sm:p-8 rounded-3xl border border-brand-primary/20 shadow-sm">
        <div className="space-y-1">
          ...
          <h1 className="font-serif text-2xl sm:text-3xl font-bold text-brand-dark">
            Управление на Картата с Локации
          </h1>
        ...
        <Card className="lg:col-span-6 p-6 sm:p-8 bg-white border border-brand-primary/20 shadow-sm rounded-3xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-brand-dark">Име на събитието / Двойка *</label>
              <input
                type="text"
                required
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-brand-primary/30 bg-brand-bg text-brand-dark text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent"
                />
              </div>
            ...
            <div className="space-y-3 pt-2 border-t border-brand-primary/10">
              <label className="text-xs font-semibold text-brand-dark flex items-center justify-between">
                <span className="flex items-center space-x-1">
                  <Layers className="w-4 h-4 text-brand-accent" />
                  <span>Галерия със снимки за събитието ({formData.galleryImages.length})</span>
                </span>
              </label>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-xl border border-brand-primary/30 bg-brand-bg text-xs text-brand-dark placeholder:text-brand-dark/40 focus:outline-none focus:ring-1 focus:ring-brand-accent"
                />
                <Button
                  type="button"
                ...
                >
                  <Plus className="w-4 h-4 mr-1 text-brand-accent" />
                  Добави
                </Button>
              </div>
              ...
              <div className="space-y-1">
                <span className="text-[10px] text-brand-dark/60 font-medium">Бързо кликнете за добавяне от налични кадъра:</span>
            ...
            {/* Event Description */}
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-brand-dark">Кратко описание за спомена</label>
              <textarea
                rows={3}
        ...
        <Card className="lg:col-span-6 p-6 sm:p-8 bg-white border border-brand-primary/20 shadow-sm rounded-3xl space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <p className="text-xs text-brand-dark/70">
              Кликнете върху произволно място на картата или плъзгайте маркера. Координатите се попълват автоматично.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-brand-secondary/30 border border-brand-primary/20 text-xs text-brand-dark/80 space-y-1">
            <span className="font-bold text-brand-accent">💡 Инструкция:</span>
            <p>
              Кликнете върху желаното място на картата, за да поставите пина. Използвайте мащабирането (+/-) за прецизно локализиране.
            </p>
          </div>
        </Card>
      </div>
